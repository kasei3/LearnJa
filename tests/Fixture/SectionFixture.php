...
class SectionFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'section_name' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'describe' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_time' => '2018-12-24 14:55:17'
            ],
        ];
        parent::init();
    }
